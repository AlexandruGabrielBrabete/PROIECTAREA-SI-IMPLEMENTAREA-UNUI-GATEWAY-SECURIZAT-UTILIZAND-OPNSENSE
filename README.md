...
1. **Fișierele Mașinii Virtuale** Exportul fișierului **configuration.xml** al firewall-ului OPNsense pre-configurat cu toate regulile, alias-urile și serviciile activate se poate face la cerere, în privat.
